...
@Slf4j
public class AiResourceListener1 extends AnalysisEventListener<AiResourceVo> implements ExcelListener<AiResourceVo> {
    ...
    public void invoke(AiResourceVo aiResourceVo, AnalysisContext analysisContext) {
        try {
            ...
            aiResource.setType("教师文档");
            aiResource.setApplicableObjects("教师");
